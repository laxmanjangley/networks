HTTP/1.1 200 OK
Date: Tue, 06 Oct 2015 18:28:33 GMT
Server: Apache/2.2.22 (Ubuntu) mod_fcgid/2.3.6 mod_ssl/2.2.22 OpenSSL/1.0.1
Last-Modified: Sat, 03 Jul 2010 03:00:40 GMT
ETag: "1a2af6-18ee-48a72e897a600"
Accept-Ranges: bytes
Content-Length: 6382
...
// $Id: script.js,v 1.1.2.6 2010/07/03 03:00:39 sociotech Exp $Drupal.behaviors.fusionEqualheights = function (context) {
  if (jQuery().equalHeights) {
    $("#header-top-wrapper div.equal-heights div.content").equalHeights();
    $("#header-group-wrapper div.equal-heights div.content").equalHeights();
    $("#preface-top-wrapper div.equal-heights div.content").equalHeights();
